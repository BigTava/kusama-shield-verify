    ...
    function verifyProof(
        ...
        assembly ("memory-safe") {
...

            {
                ...
                success := and(
                    success,
                    eq(0x0780, calldataload(PROOF_LEN_CPTR))
                )
            ...
            // Compute quotient evavluation
            {
                ...
                let y := mload(Y_MPTR)
                {
                    ...
                    let var4 := mulmod(
                        var3,
                        0x9600146bec7f4fd625ea9db1f247c6376f479f8fa4b34f1227f14ac41bc4cd3,
                        r
                    )
                    ...
                    let var15 := mulmod(
                        var14,
                        0x868c3677aaeb8a5b01fc0c44f5d2367a26db160ae28eb98b63cccbea20d8af,
                        r
                    )
                ...
                }
                {
                    ...
                    let var4 := mulmod(
                        var3,
                        0xb9a382db8289f520ece763cbb2094c444663a2bf55db56999a4614a96504ebe,
                        r
                    )
                    let a_1 := calldataload(0x03a4)
                    let f_1 := calldataload(0x0544)
                    ...
                    let var9 := mulmod(
                        var8,
                        0x2de7772476f303a6d2879cdcc47c1113ef4e1936fb876d034bbcda5acdc435ec,
                        r
                    )
                    let var10 := addmod(var4, var9, r)
                    let a_2 := calldataload(0x03c4)
                ...
                }
                {
                    ...
                    let var9 := mulmod(
                        var8,
                        0xd7b02b0f922e679dfd828024c17296596770fdc936f9b16ae612716ce444b3b,
                        r
                    )
                    let var10 := addmod(var4, var9, r)
                    let a_2 := calldataload(0x03c4)
                ...
                }
                {
                    ...
                    let var11 := mulmod(
                        a_0_next_1,
                        0x1853f03f9b252eeb4def04f67ea4695d3e91e73306f0cd432f1e66ed55f9c9fc,
                        r
                    )
                    let a_1_next_1 := calldataload(0x0404)
                    let var12 := mulmod(
                        a_1_next_1,
                        0x132185516ff7885d531ce5e3792c993644db50db384d01a122b56ca429c363fc,
                        r
                    )
                    ...
                    let var14 := mulmod(
                        a_2_next_1,
                        0x48c9fd0418a78de7ccd2f5fd6e0a05b79a6862e163c5e40e9f26d10389937e7,
                        r
                    )
                ...
                }
                {
                    ...
                    let var8 := mulmod(
                        a_0_next_1,
                        0x1c57f77f7c6e2d7022535c06418140c40e6a2162b3311237b782b5fc2ef1eef5,
                        r
                    )
                    let a_1_next_1 := calldataload(0x0404)
                    let var9 := mulmod(
                        a_1_next_1,
                        0x1e830536445074ac249acf6af5d2bddc40e64ba0515d988e670aef95c403752a,
                        r
                    )
                    ...
                    let var11 := mulmod(
                        a_2_next_1,
                        0x255e46607289f38834ad7a9180132c72025c31fa10473f628051c9632e142537,
                        r
                    )
                ...
                }
                {
                    ...
                    let var8 := mulmod(
                        a_0_next_1,
                        0x92ca526b2fdef96c0ec02fce8d51fdea61725cbff027a2e24ebea472f8a4181,
                        r
                    )
                    let a_1_next_1 := calldataload(0x0404)
                    let var9 := mulmod(
                        a_1_next_1,
                        0xf2380249580f86a2c30b2e3432d19969396c30ce1a1bf4a7cbe164eddf2ed1,
                        r
                    )
                    let var10 := addmod(var8, var9, r)
                    let a_2_next_1 := calldataload(0x0424)
                    let var11 := mulmod(
                        a_2_next_1,
                        0xf03e31e34235cbb100bea16d54ec9e3a0e3f64ce8b0590a80de8813ede171ea,
                        r
                    )
                    let var12 := addmod(var10, var11, r)
                    let var13 := sub(r, var12)
                ...
                }
                {
                    ...
                    let eval := addmod(
                        l_0,
                        sub(r, mulmod(l_0, calldataload(0x06e4), r)),
                        r
                    )
                    quotient_eval_numer := addmod(
                        mulmod(quotient_eval_numer, y, r),
                ...
                }
                {
                    ...
                    lhs := mulmod(
                        ...
                        addmod(
                            addmod(
                                ...
                                mulmod(beta, calldataload(0x0604), r),
                                r
                            ),
                            gamma,
                            r
                    ...
                    lhs := mulmod(
                        ...
                        addmod(
                            addmod(
                                calldataload(0x04c4),
                                mulmod(beta, calldataload(0x0624), r),
                                r
                            ),
                            gamma,
                            r
                    ...
                    lhs := mulmod(
                        ...
                        addmod(
                            addmod(
                                calldataload(0x0384),
                                mulmod(beta, calldataload(0x0644), r),
                                r
                            ),
                            gamma,
                            r
                    ...
                    lhs := mulmod(
                        ...
                        addmod(
                            addmod(
                                calldataload(0x03a4),
                                mulmod(beta, calldataload(0x0664), r),
                                r
                            ),
                            gamma,
                            r
                    ...
                    rhs := mulmod(
                        rhs,
                        addmod(
                            addmod(calldataload(0x04c4), mload(0x00), r),
                            gamma,
                            r
                        ),
                        r
                    ...
                    rhs := mulmod(
                        rhs,
                        addmod(
                            addmod(calldataload(0x0384), mload(0x00), r),
                            gamma,
                            r
                        ),
                        r
                    ...
                    rhs := mulmod(
                        rhs,
                        addmod(
                            addmod(calldataload(0x03a4), mload(0x00), r),
                            gamma,
                            r
                        ),
                        r
                ...
                }
                {
                    ...
                    lhs := mulmod(
                        ...
                        addmod(
                            addmod(
                                calldataload(0x03c4),
                                mulmod(beta, calldataload(0x0684), r),
                                r
                            ),
                            gamma,
                            r
                    ...
                    lhs := mulmod(
                        ...
                        addmod(
                            addmod(
                                calldataload(0x04e4),
                                mulmod(beta, calldataload(0x06a4), r),
                                r
                            ),
                            gamma,
                            r
                    ...
                    lhs := mulmod(
                        ...
                        addmod(
                            addmod(
                                calldataload(0x0504),
                                mulmod(beta, calldataload(0x06c4), r),
                                r
                            ),
                            gamma,
                            r
                    ...
                    rhs := mulmod(
                        rhs,
                        addmod(
                            addmod(calldataload(0x03c4), mload(0x00), r),
                            gamma,
                            r
                        ),
                        r
                    ...
                    rhs := mulmod(
                        rhs,
                        addmod(
                            addmod(calldataload(0x04e4), mload(0x00), r),
                            gamma,
                            r
                        ),
                        r
                    ...
                    rhs := mulmod(
                        rhs,
                        addmod(
                            addmod(calldataload(0x0504), mload(0x00), r),
                            gamma,
                            r
                        ),
                        r
            ...
            // Compute pairing lhs and rhs
            {
                ...
                }
                {
                    ...
                    coeff := mulmod(
                        coeff,
                        addmod(point_1, sub(r, point_3), r),
                        r
                    )
                ...
                }
                {
                    ...
                    r_eval := addmod(
                        r_eval,
                        mulmod(mload(0x20), calldataload(0x0464), r),
                        r
                    )
                    r_eval := addmod(
                        r_eval,
                        mulmod(mload(0x40), calldataload(0x03c4), r),
                        r
                    )
                    r_eval := addmod(
                        r_eval,
                        mulmod(mload(0x60), calldataload(0x0424), r),
                        r
                    )
                    r_eval := mulmod(r_eval, zeta, r)
                    r_eval := addmod(
                        r_eval,
                        mulmod(mload(0x20), calldataload(0x04a4), r),
                        r
                    )
                    r_eval := addmod(
                        r_eval,
                        mulmod(mload(0x40), calldataload(0x03a4), r),
                        r
                    )
                    r_eval := addmod(
                        r_eval,
                        mulmod(mload(0x60), calldataload(0x0404), r),
                        r
                    )
                    r_eval := mulmod(r_eval, zeta, r)
                    r_eval := addmod(
                        r_eval,
                        mulmod(mload(0x20), calldataload(0x0484), r),
                        r
                    )
                    r_eval := addmod(
                        r_eval,
                        mulmod(mload(0x40), calldataload(0x0384), r),
                        r
                    )
                    r_eval := addmod(
                        r_eval,
                        mulmod(mload(0x60), calldataload(0x03e4), r),
                        r
                    )
                ...
                }
                {
                    ...
                    r_eval := addmod(
                        r_eval,
                        mulmod(coeff, calldataload(0x0444), r),
                        r
                    )
                ...
                }
                {
                    ...
                    r_eval := addmod(
                        r_eval,
                        mulmod(mload(0xa0), calldataload(0x0724), r),
                        r
                    )
                    r_eval := addmod(
                        r_eval,
                        mulmod(mload(0xc0), calldataload(0x06e4), r),
                        r
                    )
                    r_eval := addmod(
                        r_eval,
                        mulmod(mload(0xe0), calldataload(0x0704), r),
                        r
                    )
                ...
                }
                {
                    ...
                    r_eval := addmod(
                        r_eval,
                        mulmod(mload(0x0100), calldataload(0x0744), r),
                        r
                    )
                    r_eval := addmod(
                        r_eval,
                        mulmod(mload(0x0120), calldataload(0x0764), r),
                        r
                    )
